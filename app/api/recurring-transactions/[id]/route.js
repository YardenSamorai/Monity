...
export async function PUT(request, { params }) {
  try {
    ...
    notifyRecurringTransactionChange(user.id, 'updated', recurringTransaction).catch((err) => console.error('Pusher error:', err))
    notifyDashboardUpdate(user.id, { action: 'recurring_transaction_updated' }).catch((err) => console.error('Pusher error:', err))
...
export async function DELETE(request, { params }) {
  try {
    ...
    notifyRecurringTransactionChange(user.id, 'deleted', { id }).catch((err) => console.error('Pusher error:', err))
    notifyDashboardUpdate(user.id, { action: 'recurring_transaction_deleted' }).catch((err) => console.error('Pusher error:', err))
