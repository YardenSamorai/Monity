...
export async function PATCH(request, { params }) {
  try {
    ...
    notifyCreditCardChange(user.id, 'updated', creditCard).catch((err) => console.error('Pusher error:', err))
...
export async function DELETE(request, { params }) {
  try {
    ...
    revalidateTag('credit-cards')
    revalidateTag('dashboard')
    notifyCreditCardChange(user.id, 'deleted', { id }).catch((err) => console.error('Pusher error:', err))
